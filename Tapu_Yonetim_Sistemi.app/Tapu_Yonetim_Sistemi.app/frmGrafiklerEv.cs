...
{
    public partial class frmGrafiklerEv : Form
    {
        public frmGrafiklerEv()
        {
            InitializeComponent();
        }
        ...
        private void frmGrafiklerEv_Load(object sender, EventArgs e)
        {
            //Sehirler
            baglanti.Open();
            SqlCommand kmt1 = new SqlCommand("select il,count(*) From Ev Group By il", baglanti);
            ...
            //Ucret
            baglanti.Open();
            SqlCommand kmt2 = new SqlCommand("select il,Avg(Ucret ) From Ev Group By il", baglanti);
